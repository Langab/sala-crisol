...
### El `?v=4` de los scripts

Los `<script>` de todas las páginas apuntan a `js/config.js?v=4` y `js/main.js?v=4`.
...
```bash
sed -i '' 's/\.js?v=4"/.js?v=5"/g' *.html talleres/*.html tertulias/*.html eventos/*.html
```
